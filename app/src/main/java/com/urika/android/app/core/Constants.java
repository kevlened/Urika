...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.urika.android.app";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Urika";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.urika.android.app.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.urika.android.app.";
